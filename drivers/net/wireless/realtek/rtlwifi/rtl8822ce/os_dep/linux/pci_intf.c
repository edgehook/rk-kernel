...
struct pci_device_id rtw_pci_id_tbl[] = {
	...
	{PCI_DEVICE_SUB(PCI_VENDER_ID_REALTEK, 0xC821, 0x1A3B, PCI_ANY_ID), .driver_data = RTL8821C},
	{PCI_DEVICE_SUB(PCI_VENDER_ID_REALTEK, 0xC82A, 0x1A3B, PCI_ANY_ID), .driver_data = RTL8821C},
	{PCI_DEVICE_SUB(PCI_VENDER_ID_REALTEK, 0xC82B, 0x1A3B, PCI_ANY_ID), .driver_data = RTL8821C},
#endif
#ifdef CONFIG_RTL8822C
      {PCI_DEVICE_SUB(PCI_VENDER_ID_REALTEK, 0xC822, 0x1A3B, PCI_ANY_ID), .driver_data = RTL8822C},
#endif
